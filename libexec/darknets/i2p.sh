...
# Variable defaults:
  ...
  : ${darknets_i2p__i2p_file='i2pinstall_0.8.8.exe'}		# The filename of the i2p installer.
  : ${darknets_i2p__i2p_sha256='32f37cd5045040da2b162b7ffa8eccd096ea2101a963590d5c1d8a7b9be3f4cc'}
